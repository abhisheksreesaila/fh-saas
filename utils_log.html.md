...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/utils_log.py#L22"
...
def log_timing_event(
    logger, label:str, started_at:float, level:int=20
):
...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/utils_log.py#L16"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/utils_log.py#L30"
target="_blank" style="float:right; font-size:smaller">source</a>
