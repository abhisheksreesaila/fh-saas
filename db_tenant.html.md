...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/db_tenant.py#L207"
...
The package caches tenant routing, SQLAlchemy engines, and reflected
table metadata, but each call returns a fresh live connection bound to
its own cloned metadata object. Callers should still close the returned
...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/db_tenant.py#L267"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/db_tenant.py#L258"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/db_tenant.py#L249"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/abhisheksreesaila/fh-saas/blob/main/fh_saas/db_tenant.py#L277"
target="_blank" style="float:right; font-size:smaller">source</a>
...
[`TenantUser`](https://abhisheksreesaila.github.io/fh-saas/db_tenant.html#tenantuser)
stores the user’s role within the tenant:
